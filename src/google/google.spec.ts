import { detectColumnsFromHeader, extractTrainIspMatchers, getCellValue, parseGoogleVisualizationJson, rowToValues } from "./google.js";
...
const RAW = {
  ...
  table: {
    ...
    rows: [
      ...
      { c: [null, { v: "hotsplots" }, { v: "AS210070 Hotsplots GmbH" }, { v: "RMV" }, { v: "Robert" }, null, null, { v: null }] },
      { c: [null, { v: "TelekomX" }, { v: "Deutsche Telekom AG" }, { v: "TEST" }, null, null, null, { v: null }] },
      { c: [null, null, { v: "AS204445 DB Systel GmbH" }, { v: "wifi@db" }, { v: "Robert" }, null, { v: "DB Bahnhof Mainz" }, { v: null }] },
      { c: [null, null, { v: "AS398830 Icomera US, Inc." }, { v: "RE14 Mainz-Frankfurt" }, null, null, null, { v: null }] },
      { c: [null, { v: "Next Layer" }, { v: "AS1764 Next Layer Telekommunikationsdienstleistungs- und Beratungs GmbH" }, { v: "ÖBB" }, { v: "Robert" }, null, null, { v: null }] },
      { c: [null, null, { v: "AS8412 T-Mobile Austria GmbH" }, { v: "MAV" }, null, null, null, { v: null }] },
      { c: [null, { v: "CD-Telematika" }, { v: "AS25512 CD-Telematika a.s." }, { v: "CD" }, null, null, null, { v: null }] }
    ],
    parsedNumHeaders: 0
  }
};
  ...
  it("should extract the matching items", () => {
    const EXPECTED = {
      ...
      matchers: [
        ...
        { context: "RE60 Rheine - Braunschweig", key: "unwirednetworks" },
